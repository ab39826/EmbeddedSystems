...
// PF0 high during critical part of main (BadFifo_Get)
...
void Timer0A_Handler(void){
  ...
  LineHistogram[(returnaddress - (unsigned long)&BadFifo_Get)/2]++;
	LastLine = (returnaddress - (unsigned long)&BadFifo_Get)/2;
  GPIO_PORTF2 = 0x00;
}
...
int main(void){
  ...
  for(i=0; i<HISTOGRAMSIZE; i=i+1){ unsigned long returnaddress;
    LineHistogram[i] = 0;
    returnaddress = ((unsigned long)&BadFifo_Get + 2*i)&0xFFFFFFFE;
...
int main2(void){    int i;
  ...
  BadFifo_Init();
  result = BadFifo_Get(&letter); // letter = ??, result = 0
  result = BadFifo_Put('A');     // result = 1
  result = BadFifo_Put('B');     // result = 1
  result = BadFifo_Put('C');     // result = 1
  result = BadFifo_Get(&letter); // letter = 0x41, result = 1
  result = BadFifo_Get(&letter); // letter = 0x42, result = 1
  result = BadFifo_Put('D');     // result = 1
  result = BadFifo_Size();       // result = 2
  result = BadFifo_Get(&letter); // letter = 0x43, result = 1
  result = BadFifo_Get(&letter); // letter = 0x44, result = 1
  result = BadFifo_Size();       // result = 0
  result = BadFifo_Get(&letter); // letter = ??, result = 0
  for(i='A'; i<'A'+RXFIFOSIZE-1; i=i+1){
    result = BadFifo_Put(i);     // result = 1
  }
  result = BadFifo_Size();       // result = 9
  result = BadFifo_Get(&letter); // letter = 0x41, result = 1
  result = BadFifo_Size();       // result = 8
  result = BadFifo_Get(&letter); // letter = 0x42, result = 1
  result = BadFifo_Size();       // result = 7
  result = BadFifo_Put(' ');     // result = 1
  result = BadFifo_Size();       // result = 8
